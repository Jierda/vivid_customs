...
<div class="row">
    <div class="col-md-4">
        <!--MENU-->
        <p>Selected: <p id="selected"></p></p>
        <!--UPLOADING/CHOOSING IMAGE SECTION-->
        ...
        <input id="remove" type="button" name="remove" value="remove" onclick="removeItem();"> 
    </div>
    <div class="col-md-4">
        <!--COLOR SECTION-->
        <div class="row"> 
            <div class="col-sm-6" >   
                <div class="list-group">
                    <a href="#" class="list-group-item active"><div style="color: #00ffff; background-color: #00ffff;" onclick="changeColor(this.innerHTML);">#00ffff</div></a>
                    <a href="#" class="list-group-item"><div style="color: #808000; background-color: #808000;" onclick="changeColor(this.innerHTML);">#808000</div></a>
                    <a href="#" class="list-group-item"><div style="color: #800000; background-color: #800000;" onclick="changeColor(this.innerHTML);">#800000</div></a>
                    <a href="#" class="list-group-item"><div style="color: #880000; background-color: #880000;" onclick="changeColor(this.innerHTML);">#880000</div></a>
                </div>
            </div> 
            <div class="col-sm-6" >
                <div class="list-group">
                    <a href="#" class="list-group-item"><div style="color: #ff0000; background-color: #ff0000;" onclick="changeColor(this.innerHTML);">#ff0000</div></a>
                    <a href="#" class="list-group-item"><div style="color: #00ff00; background-color: #00ff00;" onclick="changeColor(this.innerHTML);">#00ff00</div></a>
                    <a href="#" class="list-group-item"><div style="color: #0000ff; background-color: #0000ff;" onclick="changeColor(this.innerHTML);">#0000ff</div></a>
                    <a href="#" class="list-group-item"><div style="color: #000088; background-color: #000088;" onclick="changeColor(this.innerHTML);">#000088</div></a>
                </div>
            </div>
        </div>
        <!--END COLOR SECTION-->
    ...
    <div class="col-md-4">
        ...
        <form onsubmit="return false;">
            <input id="text" type="text" onchange="setText();" placeholder="Enter text">
            <input id="color" type="text" onchange="setColor();" placeholder="Enter hex color">
            <input id="strokeColor" type="text" onchange="setStrokeColor();" placeholder="Enter hex stroke color">
            <!--START FONTS MODAL-->
                <!-- Button trigger modal -->
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#fontModal">
                  Change Fonts
                </button>
                <!-- Modal -->
            ...
            <!--END FONTS MODAL-->
            <input type="button" value="add straight" onclick="straight();">
            <input type="button" value="add curve" onclick="curve();">
            <input type="button" value="add reverse curve" onclick="reverseCurve();">
            <input type="button" value="add circle" onclick="circle();">
            <input type="button" value="clear" onclick="canvas.clear();"> <!--this is how you clear the canvas with fabric.js-->
        </form>
...
<!--START CAROUSEL-->
<p id="test">nothing</p>
<button id="rotate" style="display: block; margin: auto;" onclick="rotate();">Rotate</button>
    ...
    <div class="carousel-inner">
      <div class="item active">
                <div id="canvasShirt" style="width: 750; height: 1000; display: block; margin: auto; background-image: url('img/shirt.png'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
                    <canvas id="frontCanvas" width="488" height="650"  style="margin: 175 131 175 131;  border: 1px solid #000000; display: block;"></canvas><!--FRONT SHIRT CANVAS-->
                </div>
      ...
      <div class="item">
         <div id="canvasShirt" style="width: 750; height: 1000; display: block; margin: auto; background-image: url('img/shirt.png'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
            <canvas id="rightCanvas" width="244" height="325"  style="margin: 350 262 350 262;  border: 1px solid #000000; display: block;"></canvas><!--RIGHT SHIRT CANVAS-->
        </div>
        <div class="carousel-caption">
          <p>Right</p>
        </div>
      ...
      <div class="item">
         <div id="canvasShirt" style="width: 750; height: 1000; display: block; margin: auto; background-image: url('img/shirt.png'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
            <canvas id="backCanvas" width="488" height="650"  style="margin: 175 131 175 131;  border: 1px solid #000000; display: block;"></canvas><!--BACK SHIRT CANVAS-->
        </div>
        <div class="carousel-caption">
          <p>Back</p>
        </div>
        ...
        <!--start-->
              <div class="item">
        <div id="canvasShirt" style="width: 750; height: 1000; display: block; margin: auto; background-image: url('img/shirt.png'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
            <canvas id="leftCanvas" width="244" height="325"  style="margin: 350 262 350 262;  border: 1px solid #000000; display: block;"></canvas><!--LEFT SHIRT CANVAS-->
        </div>
        <div class="carousel-caption">
            <p>Left</p>
        </div>
...
<div class="row">
    ...
    <div class="col-sm-4">
        <input id="quantity" type="number" placeholder="Enter quantity" onchange="setQuantity(this.value);">
        <input id="price" type="button" name="" value="Price" onclick="showPrice();">
        <p id="showPrice"></p>
    </div>
                ...
                <div class="modal-body">                 
                  ...
                  <label for="usr">Name:</label>
                   ...
                   <label for="usr">Phone:</label>
                    ...
                    <input type="text" class="form-control" id="paymentinfo" placeholder="Payment info">
                    <label for="usr">Product info:</label>
                    <input type="text" class="form-control" id="productinfo" placeholder="Product info">
                    ...
                    <a href="#demo" data-toggle="collapse">Pickup</a>
                    <div id="demo" class="collapse">
                      <div class="dropdown">
                        <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">ShippingType
                        <span class="caret"></span></button>
                        <ul class="dropdown-menu">
                          <li><a href="#">ShippingType1</a></li>
                          <li><a href="#">ShippingType2</a></li>
                          <li><a href="#">ShippingType3</a></li>
                        </ul>
                      </div>
                    ...
                    <input type="text" class="form-control" id="postalcode" placeholder="Zip or Postal Code">
                    </div>
                  </form>
                </div>
                <div class="modal-footer">
    ...
    <script>
       ...
       $.ajax({
            type:    "GET",
            dataType: "JSON",
            url:     "whiteyoel/whiteyoel_000121/whiteyoel_000121.json",
            success: function(text) {    
                ...
                //this code apply the filter of the image and render but do not found with text object
                /* front.loadFromJSON(text[0], function () {
                    front.forEachObject(function(o) {
                        if (o.type === 'image' && o.filters.length !== 0) {                            
                            o.applyFilters(front.renderAll.bind(this));
                        }
                       
                    });
                });*/
/*
                 right.loadFromJSON(text[1], function () {
                    right.forEachObject(function(o) {
                        if (o.type === 'image' && o.filters.length !== 0) {
                            o.applyFilters(right.renderAll.bind(right));
                        }
                    });
                });

                 back.loadFromJSON(text[2], function (object) {
                    back.forEachObject(function(o) {
                        if (o.type === 'image' && o.filters.length !== 0) {
                            o.applyFilters(back.renderAll.bind(back));
                        }                                 
                    });
                 ...
                 left.loadFromJSON(text[3], function () {
                    left.forEachObject(function(o) {
                        if (o.type === 'image' && o.filters.length !== 0) {
                            o.applyFilters(left.renderAll.bind(left));
                        }
                    });
                });*/
        ...
        */
        ...
        function setCanvas(direction){
            if( direction == 'next' ){
                if( $("#frontActive").hasClass('active') ){
                    document.getElementById('test').innerHTML = "right is active";
                    canvasCounter = 2;
                }
                if( $("#rightActive").hasClass('active') ){
                    document.getElementById('test').innerHTML = "back is active";
                    canvasCounter = 3;
                }
                if( $("#backActive").hasClass('active') ){
                    document.getElementById('test').innerHTML = "left is active";
                    canvasCounter = 4;
                }
                if( $("#leftActive").hasClass('active') ){
                    document.getElementById('test').innerHTML = "front is active";
                    canvasCounter = 1;
                }
            } else {
                if( $("#frontActive").hasClass('active') ){
        ...
        //ROTATING SHIRT FOR DESIGN !!!!!!!!!!!GET RID OF THIS FUNCTION!!!!!!!!!!!!
        function rotate(){
            //TODO make sure you save the number of objects before rotating canvases
            //alert("marker:\n front "+ frontCanvas.style.display +"\n right "+ rightCanvas.style.display +"\n back "+ backCanvas.style.display +"\n left " + leftCanvas.style.display);
            //console.log("marker:\n front "+ frontCanvas.style.display +"\n right "+ rightCanvas.style.display +"\n back "+ backCanvas.style.display +"\n left " + leftCanvas.style.display);
            console.log(canvas);
            if(canvasCounter == 1){
                alert("right");
               ...
               /* frontCanvas.style.display = "none";
                ...
                //canvas = new fabric.Canvas('rightCanvas');
               // canvas = front;
                canvasCounter = 2;
                
            }  else if ( canvasCounter == 2){
                alert("back");
                canvas = back;
                     /* frontCanvas.style.display = "none";
                leftCanvas.style.display = "none";
                backCanvas.style.display = "none";
                document.getElementById('rightCanvas').style.display = "block"; */
                //canvas = new fabric.Canvas('backCanvas');
               // canvas = right;
                canvasCounter = 3;
            } else if(canvasCounter == 3){
                alert("left");
                canvas = left;
                     /* frontCanvas.style.display = "none";
                leftCanvas.style.display = "none";
                backCanvas.style.display = "none";
                document.getElementById('rightCanvas').style.display = "block"; */
                //canvas = new fabric.Canvas('leftCanvas');
               // canvas = back;
                canvasCounter = 4;
            } else{
                alert("front");
        ...
        //CHANGING MENU TO WHAT IS SELECTED !!!!!!!!!!!GET RID OF THIS FUNCTION!!!!!!!!!!!!
        function changeMenu(event){
            var selected = document.getElementById('selected');
            //selected.innerHTML = canvas.getActiveObject().get('type');
        }
        canvas.on('object:selected',changeMenu);
        ...
        function changeColor(newColor){
           ...
           // $(".list-group-item").on("click", function() {
            ...
            //});
            //this is changing the color of the clip art
    ...
    <div>
        <input type="button" class="btn btn-primary" onclick="uploadEx()" value="Save Design" />
    </div>
